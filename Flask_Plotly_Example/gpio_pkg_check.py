...
try:
    import gpiozero
    print('GPIOZero   Available', 'Version: ', gpiozero.__version__)
except:
...
try:
    import pigpio
    print('PiGPIO     Available', 'Version: ', pigpio.__version__)
except:
    print('PiGPIO     Unavailable. Install with "pip install pigpio"')

try:
    import RPi.GPIO
    print('RPi.GPIO     Available', 'Version: ', RPI.GPIO.__version__)
except:
...
try:
    import flask
    print('flask	Available.', 'Version: ', flask.__version__)
except:
